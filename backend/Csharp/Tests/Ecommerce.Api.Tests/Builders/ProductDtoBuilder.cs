...
{
    // private Guid _productId = Guid.NewGuid(); // is private set, so it will be generated by the constructor of ProductDTO
    ...
    public ProductDTO Build()
    {
        ...
        {
            // ProductId = _productId, // is private set, so it will be generated by the constructor of ProductDTO
            Name = _name,
            Price = _price,
            HexColor = _hexColor,
            Size = _size,
