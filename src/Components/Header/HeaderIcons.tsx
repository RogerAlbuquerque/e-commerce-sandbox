		...
		icon == 'heart' ?
			...
			icon	== 'compare' ?
				...
				icon == 'cart' ?
					...
					:
					icon == 'downArrow' &&
					<svg xmlns="http://www.w3.org/2000/svg"  width="12" height="22"  viewBox="0 100 512 400" id="down-arrow"><path d="m396.6 160 19.4 20.7L256 352 96 180.7l19.3-20.7L256 310.5z"></path></svg>;
