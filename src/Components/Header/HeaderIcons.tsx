...
export default function SearchIconButton({icon}:typeIcon){
		...
		icon == 'heart' ?
			...
			icon	== 'compare' ?
				...
				icon == 'cart' ?
					...
					:
					icon == 'downArrow' &&
					<svg xmlns="http://www.w3.org/2000/svg" fill = {isActive ? 'black' : 'white'} onMouseEnter={() => setIsActive(false)} onMouseLeave={() => setIsActive(true)} style={{transition: 'fill 0.4s', cursor:'pointer'}} width="12" height="22"  viewBox="0 100 512 400" id="down-arrow"><path d="m396.6 160 19.4 20.7L256 352 96 180.7l19.3-20.7L256 310.5z"></path></svg>;
