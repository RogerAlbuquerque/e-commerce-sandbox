...
export default function ScrollListProducts({listId}:TypelistId){
	return(
		<section className='relative flex mb-20 overflow-x-hidden'>
			<section>
				<div id={`listProducts${listId}`}  className={`${listId != 1 && 'hidden'} flex bg-red-600 max-md:pl-0 pl-4 gap-4 items-center overflow-x-hidden max-md:overflow-x-scroll scroll-smooth `}>
				...
				<div id={`listProducts${listId}`} className={`${listId != 2 && 'hidden'} flex bg-green-600 max-md:pl-0 pl-4 gap-4 items-center overflow-x-hidden max-md:overflow-x-scroll scroll-smooth `}>
					<CardProduct sale={true} topProduct={true} />
					<CardProduct newProduct={true} topProduct={true} />
					<CardProduct topProduct={true} />
					<CardProduct newProduct={true} topProduct={true} />
				...
				<div id={`listProducts${listId}`} className={`${listId != 3 && 'hidden'} flex bg-blue-600 max-md:pl-0 pl-4 gap-4 items-center overflow-x-hidden max-md:overflow-x-scroll scroll-smooth `}>
					<CardProduct sale={true} topProduct={true} />
					<CardProduct newProduct={true} topProduct={true} />
					<CardProduct topProduct={true} />
					<CardProduct newProduct={true} topProduct={true} />
